...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/jimmymercuri/infyeild/refs/heads/main/infyeild.lua'))()")
	end
end)
...
function glassTest()
    ...
    if humanoid then
        ...
        animation.AnimationId = "rbxassetid://7798198094"
...
addcmd('glasstest', {'Tester'}, function(args, speaker)
    if glassTest then
        glassTest()
    else
